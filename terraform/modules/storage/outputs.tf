...
output "http_standardize_names_zip" {
  value = google_storage_bucket_object.http_standardize_names_zip.name
}

output "http_standardize_phones_zip" {
  value = google_storage_bucket_object.http_standardize_phones_zip.name
}
