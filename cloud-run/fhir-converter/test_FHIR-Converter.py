...
conversion_failure_response = {'_mock_call_args': None,
         ...
         '_mock_children': {},
          ...
          'method_calls': [],
          'original_request': {'input_data': 'VALID_INPUT_DATA',
                               'input_type': 'hl7v2',
                               'root_template': 'ADT_A01'},
          'returncode': 1}
...
@mock.patch("main.open")
@mock.patch("main.subprocess.run")
def test_convert_conversion_failure(patched_subprocess_run, patched_open, patched_json_load):
